        ...
        <div class="card-body">
            <form action="{{ route('panen.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mandatory">
                    ...
                    <input type="date" class="form-control @error('tanggal_panen') is-invalid @enderror form-control-sm" id="tanggal" name="tanggal_panen" placeholder="Masukkan Tanggal">
                    @error('tanggal_panen')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group mandatory">
                    ...
                    <input type="text" class="form-control form-control-sm @error('hasil_kg') is-invalid @enderror" id="hasil_kg" name="hasil_kg[]" placeholder="Masukkan Hasil (Kg)" data-role="tagsinput">
                    @error('hasil_kg')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
